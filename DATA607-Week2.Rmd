...
{
  ratings_per_movie <-select(movieRatings, movie, ID)
...
```{r create-bar-plot}
ggplot( queryResults , aes(x = reorder(Movie_Name,Rating), y=Rating, na.rm = TRUE, fill=Movie_Name)) + geom_bar(stat ="identity") + 
